...
usage() {
    ...
    echo "  Factory, MarketFactory, Router, PragmaIndexOracle, SY, SYWithRewards, PT, YT, Market"
    echo ""
...
declare -a UPGRADEABLE_CONTRACTS=(
    ...
    "PragmaIndexOracle:PRAGMA_INDEX_ORACLE_CLASS_HASH:PRAGMA_SSTRK_ORACLE_ADDRESS,PRAGMA_WSTETH_ORACLE_ADDRESS,PRAGMA_NST_STRK_ORACLE_ADDRESS"
    "SY:SY_CLASS_HASH:SY_NST_STRK_ADDRESS,SY_SSTRK_ADDRESS,SY_WSTETH_ADDRESS,SY_HRZ_STRK_ADDRESS"
    "SYWithRewards:SY_WITH_REWARDS_CLASS_HASH:SY_WITH_REWARDS_ADDRESS"
