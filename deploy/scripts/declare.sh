...
sleep "$TX_DELAY"
declare_class "MockPragmaSummaryStats" "MOCK_PRAGMA_CLASS_HASH"
sleep "$TX_DELAY"
declare_class "MockAggregator" "MOCK_AGGREGATOR_CLASS_HASH"
sleep "$TX_DELAY"
declare_class "MockSwapCallback" "MOCK_SWAP_CALLBACK_CLASS_HASH"
sleep "$TX_DELAY"
declare_class "MockFlashCallback" "MOCK_FLASH_CALLBACK_CLASS_HASH"
sleep "$TX_DELAY"
declare_class "MockReentrantToken" "MOCK_REENTRANT_TOKEN_CLASS_HASH"
sleep "$TX_DELAY"
declare_class "Faucet" "FAUCET_CLASS_HASH"
sleep "$TX_DELAY"
declare_class "PragmaIndexOracle" "PRAGMA_INDEX_ORACLE_CLASS_HASH"
sleep "$TX_DELAY"
declare_class "PyLpOracle" "PY_LP_ORACLE_CLASS_HASH"
sleep "$TX_DELAY"
declare_class "RouterStatic" "ROUTER_STATIC_CLASS_HASH"
sleep "$TX_DELAY"
declare_class "SY" "SY_CLASS_HASH"
sleep "$TX_DELAY"
declare_class "SYWithRewards" "SY_WITH_REWARDS_CLASS_HASH"
sleep "$TX_DELAY"
