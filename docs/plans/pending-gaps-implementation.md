...
### Step 1: Add factory fee rate storage fields

#### Goal
Add `reward_fee_rate` and `default_interest_fee_rate` storage variables to Factory contract with proper placement after existing storage fields.
...
#### Files
- `contracts/src/factory.cairo` - Add constants after imports, before component declarations
...
#### Files
- `contracts/src/factory.cairo` - Add event structs after existing events (around line 130)
...
#### Files
- `contracts/src/factory.cairo` - Add function in FactoryImpl after `set_treasury` (around line 460)
...
#### Files
- `contracts/src/interfaces/i_factory.cairo` - Add 4 function signatures after `set_treasury` (around line 74)
...
#### Files
- `contracts/src/factory.cairo` - Add storage field after `default_interest_fee_rate`
...
#### Files
- `contracts/src/libraries/errors.cairo` - Add error after `FACTORY_INVALID_FEE_RATE`
...
### Step 3: Add expiry divisor event
...
### Step 4: Add expiry validation to create_yield_contracts

#### Goal
Modify `create_yield_contracts` to validate `expiry % divisor == 0` when divisor > 0 (around line 178).

#### Files
- `contracts/src/factory.cairo` - Add validation after existing expiry check at line 178
...
### Step 5: Implement set_expiry_divisor admin function
...
### Step 6: Implement get_expiry_divisor view function
...
### Step 7: Update IFactory interface with expiry divisor functions
...
#### Files
- `contracts/src/market/market_factory.cairo` - Add storage field after `default_rate_impact_sensitivity` (line 106)
...
#### Files
- `contracts/src/libraries/errors.cairo` - Add error after `MARKET_FACTORY_OVERRIDE_TOO_HIGH`
...
#### Files
- `contracts/src/market/market_factory.cairo` - Modify constructor at line 182
...
#### Files
- `contracts/src/market/market_factory.cairo` - Add validation after PT address check at line 222
...
#### Files
- `contracts/src/interfaces/i_market_factory.cairo` - Add function signatures
...
#### Files
- `contracts/tests/test_market_factory.cairo` - Add validation tests
...
#### Files
- `contracts/src/tokens/yt.cairo` - Add component declaration after ReentrancyGuardComponent (line 38)
...
#### Files
- `contracts/src/tokens/yt.cairo` - Add substorage after line 104 (decimals field)
...
#### Files
- `contracts/src/tokens/yt.cairo` - Add `RewardManagerEvent: RewardManagerComponent::Event` to Event enum (around line 133)
...
#### Files
- `contracts/src/tokens/yt.cairo` - Add impl block after existing component impls (around line 52)
...
#### Files
- `contracts/src/tokens/yt.cairo` - Add transfer hook implementation
...
#### Files
- `contracts/src/interfaces/i_yt.cairo` - Add function signatures after `interest_fee_rate` (line 98)
...
#### Files
- `contracts/src/factory.cairo` - Update `create_yield_contracts` signature and calldata building (around line 207)
...
#### Files
- `contracts/tests/test_yt_rewards.cairo` - New test file
...
#### Files
- `contracts/src/interfaces/i_router.cairo` - Add function after `add_liquidity_single_token` (line 572)
...
#### Files
- `contracts/src/router.cairo` - Add function after `add_liquidity_single_token`
...
#### Files
- `contracts/src/interfaces.cairo` - Add module declaration

#### Validation
```bash
grep -q "i_flash_callback" contracts/src/interfaces.cairo && echo "OK"
```
...
#### Files
- `contracts/src/libraries/errors.cairo` - Add after existing YT errors
...
#### Files
- `contracts/src/tokens/yt.cairo` - Add event struct after existing events
...
#### Files
- `contracts/src/interfaces/i_yt.cairo` - Add function signature
...
#### Files
- `contracts/tests/test_yt_flash.cairo` - New test file
...
#### Files
- `contracts/src/tokens/pt.cairo` - Add constant after imports
...
#### Files
- `contracts/src/tokens/yt.cairo` - Add constant after imports
...
#### Files
- `contracts/src/factory.cairo` - Add constant after imports
...
#### Files
- `contracts/src/market/market_factory.cairo` - Add constant after imports
...
#### Failure modes
- MarketState struct definition if not exists
...
#### Files
- `contracts/src/interfaces/i_market.cairo` - Add function signature and MarketState struct
