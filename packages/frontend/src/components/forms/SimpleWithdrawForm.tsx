        ...
        <div className="space-y-4">
          ...
          {!market.isExpired && (
            <div className="text-muted-foreground space-y-1 text-xs">
              <p>
                Withdrawing before maturity ({maturityDate}) requires equal amounts of both
                positions. After maturity, you can withdraw your Fixed-Rate Position directly.
              </p>
            </div>
          )}
