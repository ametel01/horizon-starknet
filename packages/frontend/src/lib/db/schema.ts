...
export const marketDailyStats = pgView('market_daily_stats', {
  ...
  implied_rate_close: numeric('implied_rate_close', { precision: 78, scale: 0 }),
  exchange_rate_close: numeric('exchange_rate_close', { precision: 78, scale: 0 }),
...
export const userPositionsSummary = pgView('user_positions_summary', {
  ...
  avg_entry_py_index: numeric('avg_entry_py_index', { precision: 78, scale: 0 }),
  avg_entry_exchange_rate: numeric('avg_entry_exchange_rate', { precision: 78, scale: 0 }),
...
export const userLpPositions = pgView('user_lp_positions', {
  ...
  avg_entry_implied_rate: numeric('avg_entry_implied_rate', { precision: 78, scale: 0 }),
  avg_entry_exchange_rate: numeric('avg_entry_exchange_rate', { precision: 78, scale: 0 }),
  avg_exit_implied_rate: numeric('avg_exit_implied_rate', { precision: 78, scale: 0 }),
  avg_exit_exchange_rate: numeric('avg_exit_exchange_rate', { precision: 78, scale: 0 }),
  first_mint: timestamp('first_mint'),
  last_activity: timestamp('last_activity'),
  mint_count: bigint('mint_count', { mode: 'number' }),
