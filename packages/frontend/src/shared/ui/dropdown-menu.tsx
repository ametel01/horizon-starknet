...
function DropdownMenu({ ...props }: MenuPrimitive.Root.Props): React.ReactNode {
  return <MenuPrimitive.Root data-slot="dropdown-menu" {...props} />;
}

function DropdownMenuPortal({ ...props }: MenuPrimitive.Portal.Props): React.ReactNode {
  return <MenuPrimitive.Portal data-slot="dropdown-menu-portal" {...props} />;
}

function DropdownMenuTrigger({ ...props }: MenuPrimitive.Trigger.Props): React.ReactNode {
...
function DropdownMenuGroup({ ...props }: MenuPrimitive.Group.Props): React.ReactNode {
...
function DropdownMenuSub({ ...props }: MenuPrimitive.SubmenuRoot.Props): React.ReactNode {
...
function DropdownMenuCheckboxItem({
  ...
  checked = false,
  ...props
}: MenuPrimitive.CheckboxItem.Props): React.ReactNode {
  return (
...
function DropdownMenuRadioGroup({ ...props }: MenuPrimitive.RadioGroup.Props): React.ReactNode {
...
function DropdownMenuRadioItem({
  ...
  children,
  ...props
}: MenuPrimitive.RadioItem.Props): React.ReactNode {
  return (
...
function DropdownMenuSeparator({
  className,
  ...props
}: MenuPrimitive.Separator.Props): React.ReactNode {
  return (
