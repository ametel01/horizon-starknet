export const YT_ABI = [
  ...
  },
  {
    type: 'impl',
    name: 'YTAdminImpl',
    interface_name: 'horizon::interfaces::i_yt::IYTAdmin',
  },
  {
    type: 'interface',
    name: 'horizon::interfaces::i_yt::IYTAdmin',
    items: [
      {
        type: 'function',
        name: 'pause',
  ...
  },
  {
    ...
    members: [
      ...
      {
        name: 'total_pt_supply_after',
        type: 'core::integer::u256',
        kind: 'data',
      },
      {
        name: 'total_yt_supply_after',
        type: 'core::integer::u256',
        kind: 'data',
      },
      {
  ...
  {
    type: 'event',
    name: 'horizon::tokens::yt::YT::ExpiryReached',
    kind: 'struct',
    members: [
      {
        name: 'market',
