...
import { db, marketDailyStats, rateHistory } from '@shared/server/db';
...
export async function GET(
  ...
  if (rateLimitResult) return rateLimitResult as NextResponse<RatesResponse>;
  ...
  try {
    ...
    logError(error, { module: 'markets/rates', marketAddress: address });
