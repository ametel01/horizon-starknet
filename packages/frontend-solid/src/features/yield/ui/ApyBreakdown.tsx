  ...
  return (
    <div class={cn('space-y-4', local.class)}>
        ...
        <div class="space-y-3">
          <div class="border-accent/30 bg-accent/10 rounded-lg border p-4">
            ...
            <div
              class={cn(
                'text-2xl font-bold',
                local.breakdown.ytApy.longYieldApy >= 0 ? 'text-primary' : 'text-destructive'
              )}
            >
          ...
          <div class="space-y-2">
            ...
            <ApyRow
              ...
              highlight={local.breakdown.underlying.totalApy > local.breakdown.ytApy.breakEvenApy}
            />
          </div>
        </div>
      </Show>
      ...
      <div class="border-border border-t pt-3">
        <div class="text-muted-foreground mb-2 text-xs font-medium">Underlying Asset Yield</div>
        <div class="space-y-1">
          <div class="flex justify-between text-sm">
            <span class="text-muted-foreground">Interest APY</span>
            <span class={getApyColorClass(local.breakdown.underlying.interestApy)}>
  ...
  return (
    <Card class={local.class}>
      <CardContent class="p-4">
        <h3 class="text-foreground mb-3 text-sm font-medium">{local.title ?? defaultTitle()}</h3>
