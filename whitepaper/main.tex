...
\begin{center}
  ...
  {\large Technical Specification | Version 2.0}
  ...
  {\footnotesize License: BUSL-1.1 (converts to GPL-3.0 on 2028-12-19)}
\end{center}
...
\input{sections/05_economic_analysis}

\chapter{Risk Analysis \& Threat Model}
\input{sections/06_risk_analysis}

\chapter{Governance \& Upgrade Model}
\input{sections/07_governance}
...
\input{sections/B_examples}

\chapter{Contract Interface Specifications}
\input{sections/C_interfaces}

\chapter{Glossary}
\addcontentsline{toc}{chapter}{Glossary}
\input{sections/D_glossary}
