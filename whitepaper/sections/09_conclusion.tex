...
The following trade-offs were intentionally chosen to balance correctness, complexity, and deployability for a v2 protocol.
...
This document specifies Horizon Protocol v2.0.
...
\noindent\textbf{This document constitutes the complete technical specification for Horizon Protocol v2.0. Any behavior not described herein is considered undefined.}
